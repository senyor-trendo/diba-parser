...
import { checkPageType, extractBookInfo, extractBookStatus } from './raw-parser';
import { PageType } from './parser.interfaces';
	...
	try {
		...
		switch (pageType) {
			...
			case PageType.Detail:
				const bookInfo = extractBookInfo(html, language);
